...
export const DEFAULT_ENABLED_SOURCES: Record<string, string[]> = {
  ...
  asia: ['BBC Asia', 'The Diplomat', 'South China Morning Post', 'Reuters Asia', 'Nikkei Asia', 'CNA', 'Asia News', 'The Hindu', 'Caixin', 'The Paper', '36Kr', 'Xinhua CN', 'China Daily', 'CNA Taiwan'],
