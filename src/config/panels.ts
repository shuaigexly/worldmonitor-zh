...
const FULL_PANELS: Record<string, PanelConfig> = {
  ...
  'military-correlation': { name: '军力态势', enabled: true, priority: 2 },
  'escalation-correlation': { name: '升级监控', enabled: true, priority: 2 },
  'economic-correlation': { name: '经济战', enabled: true, priority: 2 },
  'disaster-correlation': { name: '灾害连锁', enabled: true, priority: 2 },
