...
const DESKTOP_RELEASES_URL = 'https://github.com/shuaigexly/worldmonitor-zh/releases';
...
export function renderPreferences(host: PreferencesHost): PreferencesResult {
  ...
  `;
  html += `<a href="https://github.com/shuaigexly/worldmonitor-zh/discussions" target="_blank" rel="noopener noreferrer" class="us-discussion-link">
