...
export const CHOKEPOINTS: ChokepointConfig[] = [
  { id: 'suez', name: '苏伊士运河', lat: 30.45, lon: 32.35, primaryKeywords: ['suez canal', 'suez'], areaKeywords: ['suez canal', 'suez', 'gulf of suez', 'red sea'], routes: ['中欧航线(苏伊士)', '海湾-欧洲石油', '卡塔尔LNG-欧洲'], threatLevel: 'high', threatDescription: 'JWC高风险区 -- 毗邻活跃红海冲突区及伊以战争外溢', directions: ['北行', '南行'] },
  { id: 'malacca_strait', name: '马六甲海峡', lat: 2.5, lon: 101.5, primaryKeywords: ['strait of malacca', 'malacca'], areaKeywords: ['strait of malacca', 'malacca', 'singapore strait'], routes: ['中国-中东石油', '中欧航线(经苏伊士)', '日本-中东石油'], threatLevel: 'normal', threatDescription: '', directions: ['北行', '南行'] },
  { id: 'hormuz_strait', name: '霍尔木兹海峡', lat: 26.56, lon: 56.25, primaryKeywords: ['strait of hormuz', 'hormuz'], areaKeywords: ['strait of hormuz', 'hormuz', 'persian gulf', 'arabian gulf', 'gulf of oman', 'iran naval', 'iran military'], routes: ['海湾石油出口', '卡塔尔LNG', '伊朗出口'], threatLevel: 'war_zone', threatDescription: '活跃冲突 -- 伊以战争;伊朗海军封锁风险,波斯湾报告发现水雷', directions: ['东行', '西行'] },
  { id: 'bab_el_mandeb', name: '曼德海峡', lat: 12.58, lon: 43.33, primaryKeywords: ['bab el-mandeb', 'bab al-mandab'], areaKeywords: ['bab el-mandeb', 'bab al-mandab', 'mandeb', 'aden', 'houthi', 'yemen', 'gulf of aden', 'red sea'], routes: ['苏伊士-印度洋', '海湾-欧洲石油', '红海过境'], threatLevel: 'critical', threatDescription: 'JWC高风险区 -- 胡塞武装持续袭击商船', directions: ['北行', '南行'] },
  { id: 'panama', name: '巴拿马运河', lat: 9.08, lon: -79.68, primaryKeywords: ['panama canal'], areaKeywords: ['panama canal', 'panama'], routes: ['美东-亚洲', '美东-南美', '大西洋-太平洋散货'], threatLevel: 'normal', threatDescription: '', directions: ['北行', '南行'] },
  { id: 'taiwan_strait', name: '台湾海峡', lat: 24.0, lon: 119.5, primaryKeywords: ['taiwan strait', 'formosa'], areaKeywords: ['taiwan strait', 'formosa', 'taiwan', 'south china sea'], routes: ['中日贸易', '韩国-东南亚', '太平洋半导体'], threatLevel: 'elevated', threatDescription: '两岸军事紧张局势与解放军演习', directions: ['北行', '南行'] },
  { id: 'cape_of_good_hope', name: '好望角', lat: -34.36, lon: 18.49, primaryKeywords: ['cape of good hope', 'good hope'], areaKeywords: ['cape of good hope', 'good hope', 'cape town', 'south africa', 'cape agulhas'], routes: ['亚欧航线(好望角)', '海湾-美洲石油', '苏伊士替代'], threatLevel: 'normal', threatDescription: '', directions: ['东行', '西行'] },
  { id: 'gibraltar', name: '直布罗陀海峡', lat: 35.96, lon: -5.35, primaryKeywords: ['strait of gibraltar', 'gibraltar'], areaKeywords: ['strait of gibraltar', 'gibraltar', 'mediterranean', 'algeciras', 'tangier'], routes: ['大西洋-地中海', '海湾-欧洲石油(末段)', '印度-欧洲'], threatLevel: 'normal', threatDescription: '', directions: ['东行', '西行'] },
  { id: 'bosphorus', name: '博斯普鲁斯海峡', lat: 41.12, lon: 29.05, primaryKeywords: ['bosphorus', 'bosporus', 'dardanelles', 'canakkale', 'turkish straits'], areaKeywords: ['bosphorus', 'bosporus', 'dardanelles', 'canakkale', 'istanbul', 'marmara', 'black sea', 'turkish straits', 'gallipoli', 'aegean'], routes: ['俄罗斯黑海出口', '乌克兰粮食', '里海石油中转', '爱琴海-马尔马拉过境'], threatLevel: 'elevated', threatDescription: '蒙特勒公约限制;俄乌战争及土耳其交通管制导致风险上升', directions: ['北行', '南行'] },
  { id: 'korea_strait', name: '朝鲜海峡', lat: 34.0, lon: 129.0, primaryKeywords: ['korea strait', 'tsushima strait'], areaKeywords: ['korea strait', 'tsushima', 'busan', 'shimonoseki', 'sea of japan', 'east sea'], routes: ['日韩贸易', '中日(替代)', '太平洋-东亚'], threatLevel: 'normal', threatDescription: '', directions: ['北行', '南行'] },
  { id: 'dover_strait', name: '多佛海峡', lat: 51.05, lon: 1.45, primaryKeywords: ['dover strait', 'strait of dover', 'english channel'], areaKeywords: ['dover', 'calais', 'english channel', 'north sea', 'pas-de-calais'], routes: ['北海-大西洋', '欧洲内部贸易', '英国-欧洲大陆'], threatLevel: 'normal', threatDescription: '', directions: ['北行', '南行'] },
  { id: 'kerch_strait', name: '刻赤海峡', lat: 45.33, lon: 36.60, primaryKeywords: ['kerch strait', 'kerch bridge'], areaKeywords: ['kerch', 'crimea', 'azov', 'sea of azov', 'black sea'], routes: ['乌克兰粮食(亚速海)', '俄罗斯亚速海港口', '克里米亚补给'], threatLevel: 'war_zone', threatDescription: '活跃冲突区;俄罗斯控制刻赤大桥;乌克兰经亚速海粮食出口严重受阻', directions: ['北行', '南行'] },
  { id: 'lombok_strait', name: '龙目海峡', lat: -8.47, lon: 115.72, primaryKeywords: ['lombok strait'], areaKeywords: ['lombok', 'bali', 'indonesia', 'nusa tenggara'], routes: ['马六甲替代(超大型油轮)', '澳大利亚-亚洲', '印度洋-太平洋'], threatLevel: 'normal', threatDescription: '', directions: ['北行', '南行'] },
];
