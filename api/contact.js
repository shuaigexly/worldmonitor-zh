...
async function sendNotificationEmail(name, email, organization, phone, message) {
  ...
  const notifyEmail = process.env.CONTACT_NOTIFY_EMAIL || 'yhxu425aa@gmail.com';
      ...
      body: JSON.stringify({
        ...
        html: `
          <div style="font-family: -apple-system, sans-serif; max-width: 600px; margin: 0 auto;">
            ...
            <p style="color: #999; font-size: 12px; margin-top: 24px;">Sent from monitor.longyuxu.xyz</p>
          </div>`,
      }),
    });
    if (!res.ok) {
